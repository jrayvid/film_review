...
class FilmsControllerTest < ActionController::TestCase
  ...
  test "should create film" do
    assert_difference('Film.count') do
      post :create, film: { movie_duration: @film.movie_duration, rating: @film.rating, title: @film.title }
    end
  ...
  test "should update film" do
    patch :update, id: @film, film: { movie_duration: @film.movie_duration, rating: @film.rating, title: @film.title }
    assert_redirected_to film_path(assigns(:film))
  end
